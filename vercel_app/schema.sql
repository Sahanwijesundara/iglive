...
COMMENT ON COLUMN processed_webhooks.update_id IS 'The unique identifier for a Telegram update (Primary Key).';
...
COMMENT ON TABLE groups IS 'Stores information about Telegram groups managed by the system.';
